...
from aplicaciones.ccjj.models import Expediente, Procedimiento, Acta, Solicitud, Solicitante, Invitado, Parcial, Informe, IngresoConciliacion

from datetime import datetime, timedelta

class ReportePorConciliador():
